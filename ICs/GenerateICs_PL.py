...
#Generate initial conditions for a single IMBH with a pure power law density profile (no smooth cut off...)
...
edd.loadDistribution(M_PBH, rho0, gamma, pure=True)
...
print("  First Halo:")
mlist, xlist, vlist = PBH.AddDressedPBH_EMRI([0, 0, 0],[0, 0, 0],  r_soft*L_sim, M_PBH, rho0, gamma, nDM, haloID="nothing", verbose=True, pure=True)
